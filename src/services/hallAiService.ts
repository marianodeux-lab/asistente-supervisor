...
10. CIERRES TELCA / TELCA2 (SOPORTE REMOTO): Son atenciones de mesa remota exclusivas para equipos Cash Today (Smart Box). Los cajeros automáticos (ATM) NO tienen atenciones TELCA ni reciben asistencia remota jamás (solo visitas presenciales a campo). Para equipos ATM jamás debe asociarse ni mencionarse soporte remoto TELCA. Si un equipo Cash Today acumula cierres TELCA2 sin solución, es indicio de que requiere derivación a visita técnica presencial en sitio.
